...
class OutlierAnalysisPlotter(BasePlotter):
    ...
    def plot(self, df: pd.DataFrame, title: Optional[str]=None, show: bool=False) -> plt.Figure:
    ...
    def plot_and_save(self, df: pd.DataFrame, filename: str="outlier_analysis.png",
                      title: Optional[str]=None, show: bool=False) -> Path:
